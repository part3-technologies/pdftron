	...
	$jscomp.polyfill = function (p, m, l, g) {
		m &&
			($jscomp.ISOLATE_POLYFILLS
				? $jscomp.polyfillIsolated(p, m, l, g)
				: $jscomp.polyfillUnisolated(p, m, l, g));
	};
	...
	$jscomp.polyfill(
		...
		function (p) {
			...
			k.race = function (d) {
				return new k(function (h, q) {
					for (
						var r = $jscomp.makeIterator(d), u = r.next();
						!u.done;
						u = r.next()
					)
				...
				return q.done
					...
					: new k(function (r, u) {
							...
							do
								w.push(void 0),
									C++,
									l(q.value).callWhenSettled_(A(w.length - 1), u),
									(q = h.next());
							while (!q.done);
					  });
			};
	...
	(function (p) {
			...
			var g = l(2),
				k = function (h, q) {
					Object(g.a)('disableLogs') ||
						(q ? console.warn(h + ': ' + q) : console.warn(h));
				},
				t = function (h, q, r, u) {
					void 0 === u && (u = !1);
					var A = r.pop();
					...
					return Object(g.a)(void 0, void 0, Promise, function () {
						...
						return Object(g.b)(this, function (H) {
							switch (H.label) {
								...
								case 2:
									return (
										(E = self.BrotliDecode(Object(d.b)(x))),
										[2, z ? E : Object(d.a)(E)]
									);
							}
						});
			...
			(function () {
				...
				x.prototype.End = function () {
					if (this.remainingDataArrays.length) {
						for (var z = this.arrays, E = 0, H = 0; H < z.length; ++H)
							E += z[H].length;
						E = new Uint8Array(E);
						var P = 0;
					...
					var P = function () {
						...
						N.length < x.compressedMaximum
							? ((N = x.decompressFunction(N, x.shouldOutputArray)),
							  ...
							  q &&
									Object(k.a)('worker', 'Decompressed length is ' + N.length))
							: z && (N = Object(d.a)(N));
						q &&
							Object(k.a)(
								'worker',
								x.url + ' Decompression took ' + (Date.now() - S)
							);
						return N;
					};
					if (x.isAsync)
		...
		function (p, m, l) {
			...
			var g = function (t) {
					if ('string' === typeof t) {
						for (
							var d = new Uint8Array(t.length), h = t.length, q = 0;
							q < h;
							q++
						)
							d[q] = t.charCodeAt(q);
				...
				k = function (t) {
					if ('string' !== typeof t) {
						for (var d = '', h = 0, q = t.length, r; h < q; )
							(r = t.subarray(h, h + 1024)),
								(h += 1024),
								(d += String.fromCharCode.apply(null, r));
						return d;
					}
					return t;
				};
		...
		function (p, m, l) {
			function g(h, q, r) {
						...
						? (Object(k.a)('load', 'Try instantiateStreaming'),
						  fetch(Object(t.a)(h))
								...
								.catch(function (f) {
									Object(k.a)(
										'load',
										'instantiateStreaming Failed ' + h + ' message ' + f.message
									);
									return u(!1);
								}))
				...
				return u(!!WebAssembly.instantiateStreaming).then(function (C) {
					Object(k.a)(
						'load',
						'WASM compilation took ' + (Date.now() - (A || w)) + ' ms'
					);
					return C;
				});
			}
						...
						try {
							...
							switch (f[0]) {
								...
								default:
									...
									if (3 === f[0] && (!w || (f[1] > w[0] && f[1] < w[3])))
										r.label = f[1];
									else if (6 === f[0] && r.label < w[1])
										(r.label = w[1]), (w = f);
				...
				h = function (q, r, u) {
					if (Object(t.a)() && !u)
						(self.Module.instantiateWasm = function (w, C) {
							return Object(k.a)(q + 'Wasm.wasm', w, r['Wasm.wasm']).then(
								function (f) {
									C(f.instance);
								}
							);
		...
		function (p, m, l) {
			...
			p = (function () {
				...
				return (f =
					/(msie) ([\w.]+)/.exec(f) || /(trident)(?:.*? rv:([\w.]+)|)/.exec(f))
					? parseInt(f[2], 10)
					: f;
			})();
			var k = (function () {
			...
			var d = (function () {
					var f = g.navigator.userAgent.match(
			...
			(function (g) {
				...
				function d(f, v, y, G, J) {
					if (v) {
						...
						'' != F &&
							(I += '<Command Name="AddTableBoxes">' + F + '</Command>');
						I =
							I +
				...
				onmessage = function (f) {
					...
					switch (f.cmd) {
						...
						case 'insertNewTextBox':
							...
							FS.writeFile(B, J);
							v +=
								'<File>' + B + '</File><TransXML>coreTransXML.cfg</TransXML>';
							v +=
								'<ExportFile>' +
								I +
							...
							v +=
								'<Leading>False</Leading></Shrink><Stretch><FontSize>False</FontSize>';
						...
						case 'AlignParaText':
							...
							F = 'results' + y + '.xml';
							var H =
								'<Commands><Command Name="AlignParaText"><GID>' +
								(J + '</GID>');
							'' !== G &&
								((H =
									H +
			...
			(function (g) {
				...
				function J(a, b, c) {
					...
					if (a <= W) e = String.fromCharCode.apply(String, e);
						...
						c = '';
						for (b = 0; b < a; )
							c += String.fromCharCode.apply(String, e.slice(b, (b += W)));
						e = c;
					}
					return e;
				}
				...
				d.compare = function (a, b) {
					...
					if (a === b) return 0;
					for (
						var c = a.length, e = b.length, n = 0, D = Math.min(c, e);
						n < D;
						++n
					)
						if (a[n] !== b[n]) {
				...
				d.prototype.fill = function (a, b, c, e) {
					...
					if ('number' === typeof a) for (e = b; e < c; ++e) this[e] = a;
						...
						for (
							a = d.isBuffer(a) ? a : E(new d(a, e).toString()),
								n = a.length,
								e = 0;
							e < c - b;
							++e
		...
		function (p, m, l) {
			...
			m.toByteArray = function (h) {
				...
				for (C = 0; C < w; C += 4)
					(r =
						...
						(u[A++] = r & 255);
				2 === q &&
					((r = (t[h.charCodeAt(C)] << 2) | (t[h.charCodeAt(C + 1)] >> 4)),
					(u[A++] = r & 255));
				1 === q &&
					((r =
						(t[h.charCodeAt(C)] << 10) |
						(t[h.charCodeAt(C + 1)] << 4) |
						(t[h.charCodeAt(C + 2)] >> 2)),
					(u[A++] = (r >> 8) & 255),
					(u[A++] = r & 255));
				return u;
			};
			m.fromByteArray = function (h) {
				for (
					var q = h.length, r = q % 3, u = [], A = 0, w = q - r;
					A < w;
					A += 16383
				) {
					for (
