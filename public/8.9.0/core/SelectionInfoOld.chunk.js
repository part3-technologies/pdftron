			...
			473: function (Ba, va, r) {
				...
				Ba = (function () {
						...
						try {
							...
							for (var w = (f = 0), ea = 0; ea < z; ) {
								...
								if (0 < ka)
									(x = ka),
										++ea,
										3 === x && ((f = aa[ea]), (w = aa[ea + 1]), (ea += 2));
								else if (1 === x)
									for (a = 0; 8 > a; ++a) this.vb.push(aa[ea++]);
								else
									2 === x
										? ((h = aa[ea++]),
										  (e = aa[ea++]),
					...
					da.prototype.ix = function () {
						var aa = new oa.a();
						if (!this.nc.length)
							return aa.nh(this.nc, -1, this.Ub, this.vb, 0), aa;
				...
				Ba = (function () {
					...
					fa.prototype.dW = function (da) {
						if (0 > da || da >= this.mk())
							return (
								(da = new ma.a()),
								da.nh(this.gf, -1, -1, this.Ba, this.ub, 0),
								da
							);
						var aa = this.um() ? 6 : 10,
							y = this.um() ? 5 : 11,
					...
					fa.prototype.ho = function () {
						...
						if (da >= this.gf.length)
							return (
								(da = new fa()), da.nh(this.gf, -1, this.Ba, this.ub, 0), da
							);
						var aa = new fa();
					...
					fa.prototype.dD = function () {
						...
						0.01 > Math.abs(da.x - aa.x) &&
							0.01 > Math.abs(da.y - aa.y) &&
							this.ie.push(0);
				...
				Ba = (function () {
					...
					fa.prototype.kh = function () {
						...
						if (this.Ld >= this.pl + (da ? 6 : 10) + (this.Oea() - 1) * aa)
							return (
								(aa = new fa()), aa.nh(this.nc, -1, -1, this.Ba, this.ub, 0), aa
							);
						da = new fa();
						da.nh(
							this.nc,
					...
					fa.prototype.bea = function (da) {
						...
						return 0 > da || da >= aa
							? -1
							: parseInt(this.nc[this.Ld + 1], 10) + da;
					};
					...
					fa.prototype.oe = function (da) {
						...
						if (aa.um()) {
							...
							for (y = this.Ld + 3, x = 0; 8 > x; ++x) da[x] = this.nc[y + x];
					};
					fa.prototype.getBBox = function (da) {
						var aa = new oa.a();
						aa.nh(this.nc, this.pl, this.Ba, this.ub, 0);
