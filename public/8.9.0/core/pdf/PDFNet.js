(function () {
	...
	var $jscomp$lookupPolyfilledValue = function (target, property) {
		...
		if (null == obfuscatedName) return target[property];
		obfuscatedName = target[obfuscatedName];
		return void 0 !== obfuscatedName ? obfuscatedName : target[property];
	};
		...
		function (module, exports$jscomp$0) {
			...
			(function (exports) {
				...
				PDFNet.PDFDoc.RefreshOptions.prototype.getDrawBackgroundOnly =
					function () {
						return 'DrawBackgroundOnly' in mImpl
							? !!mImpl.DrawBackgroundOnly
							: !0;
					};
				...
				PDFNet.PDFDoc.RefreshOptions.prototype.getUseNonStandardRotation =
					function () {
						return 'UseNonStandardRotation' in mImpl
				...
				PDFNet.PDFDoc.RefreshOptions.prototype.getUseRoundedCorners =
					function () {
						return 'UseRoundedCorners' in mImpl
							? !!mImpl.UseRoundedCorners
							: !1;
					};
				...
				PDFNet.Convert.createAdvancedImagingConvertOptions = function () {
					return Promise.resolve(
						new PDFNet.Convert.AdvancedImagingConvertOptions()
					);
				};
				...
				PDFNet.Convert.AdvancedImagingConvertOptions.prototype.getDefaultDPI =
					function () {
						return 'DefaultDPI' in this.mImpl ? this.mImpl.DefaultDPI : 72;
					};
				PDFNet.Convert.AdvancedImagingConvertOptions.prototype.setDefaultDPI =
					function (value) {
						this.mHelpers.putNumber(this.mImpl, 'DefaultDPI', value);
						return this;
					};
				PDFNet.Convert.AdvancedImagingConvertOptions.prototype.getEnableAutoLevel =
					function () {
						return 'EnableAutoLevel' in this.mImpl
							? !!this.mImpl.EnableAutoLevel
							: !1;
					};
				PDFNet.Convert.AdvancedImagingConvertOptions.prototype.setEnableAutoLevel =
					function (value) {
				...
				PDFNet.Flattener.create = function () {
					return PDFNet.sendWithPromise('flattenerCreate', {}).then(function (
						id
					) {
				...
				PDFNet.Highlights.create = function () {
					return PDFNet.sendWithPromise('highlightsCreate', {}).then(function (
						id
					) {
				...
				PDFNet.PageSet.create = function () {
					return PDFNet.sendWithPromise('pageSetCreate', {}).then(function (
						id
					) {
				...
				PDFNet.TextSearch.create = function () {
					return PDFNet.sendWithPromise('textSearchCreate', {}).then(function (
						id
					) {
				...
				PDFNet.SecurityHandler.prototype.changeUserPasswordBuffer = function (
					...
					return PDFNet.sendWithPromise(
						...
						{ sh: this.id, password_buf: passwordArrayBuffer }
					);
				};
				...
				PDFNet.PDFACompliance.createFromBuffer = function (
					...
					exports.isArrayBuffer(bufArrayBuffer) ||
						(bufArrayBuffer = bufArrayBuffer.buffer);
					if (2 > arguments.length || 7 < arguments.length)
						throw new RangeError(
							arguments.length +
				...
				PDFNet.Convert.office2PDF = function (input, options) {
					return PDFNet.Convert.office2PDFBuffer(input, options).then(function (
						buffer
					) {
