	...
	function Q(k, q) {
		if (q)
			a: {
				...
				q != l &&
					null != q &&
					K(t, k, { configurable: !0, writable: !0, value: q });
			}
	}
	...
	(function (k) {
		...
		function (k, q, t) {
			function l(b, c, d, e) {
				...
				if (
					b.constructor != Array &&
					((h = b), (b = []), (m = h.length()), 16 == m || 24 == m || 32 == m)
				) {
					m >>>= 2;
						...
						finish: function (r) {
							...
							e &&
								...
								(r
									...
									: ((r = y.length()),
									  (r = y.at(r - 1)),
									  16 < r ? (v = !1) : y.truncate(r)));
							return v;
						},
						start: function (r, v) {
							r = r || F.slice(0);
							if (r.constructor == String && 16 == r.length)
								r = u.i.createBuffer(r);
				...
				if ('object' === w(a) && null !== a)
					for (var d = 0, e = b.length; d < e; ) {
						...
						if (d == e) a[f] = c;
							...
							var h = f in a;
							if (!h || (h && 'object' !== w(a[f])) || (h && null === a[f]))
								a[f] = {};
							a = a[f];
						}
					}
