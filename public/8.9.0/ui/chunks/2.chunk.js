							...
							(() => {
								...
								var j = (function (t) {
									...
									var t = e.measure,
										...
										o = e.contentRect;
									return (0,
									e.children)({ measure: t, measureRef: n, contentRect: o });
								});
												...
												(function (e, t) {
																...
																if (!_.state.isDestroyed) {
																	...
																	(_.props = o),
																		...
																		n.triggerTarget && !o.triggerTarget
																			? xt(n.triggerTarget).forEach(function (
																					e
																			  ) {
													...
													function L() {
														...
														if (t.content) {
															var n = 'aria-' + t.content,
																o = S.id;
															xt(_.props.triggerTarget || e).forEach(function (
																e
															) {
													...
													function V() {
														...
														T() &&
															...
															((e = _.props.trigger),
															e.split(/\s+/).filter(Boolean)).forEach(function (
																e
															) {
																if ('manual' !== e)
																	switch ((B(e, Z), e)) {
										...
										return (
											Ro(e, [
												...
												},
												{
													...
													value: function () {
														var e = this;
														return Object.keys(this._sections).map(function (
															t
														) {
												...
												function n() {
													...
													return (
														...
														Io(To(t), '_onScroll', function (e) {
															...
															(0,
															t.props
																.onScroll)({ clientHeight: n, scrollHeight: o, scrollTop: r });
														}),
														Io(To(t), '_onSectionRendered', function (e) {
